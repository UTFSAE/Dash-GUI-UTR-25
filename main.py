...
pygame.init()
SerialData = SerialR('dev/ttyUSB0')
...
dCoolantBar = CoolantBar(coolantSize, 0, 100)
...
while mainLoop:
    ...
    dashDisplay.fill(backgroundColor)
    dRPMbar.draw(rpm)
    dCoolantBar.draw(coolant)
    # values to string
    voltage = str(voltage)
    voltage = voltage[0] + voltage[1] + voltage[2] + voltage[3]
    dRPMbar.draw(rpm)
    dCoolantBar.draw(coolant)
    rpm2 = str(rpm/1000)
    rpm2 = list(rpm2)
    ...
    message_display('Voltage:', (255, 255, 255), 180, 245, 20)
    message_display('Lap:', (255, 255, 255), 240, 245, 20)
    message_display(str(lap), (255, 255, 255), 320, 275, 40)
    message_display(str(voltage), (255, 255, 255), 180, 275, 40)
    message_display(str(rpm), (0, 0, 0), 240, 50, 70)
    message_display(str(rpm2), (0, 0, 0), 100, 170, 55)
    message_display(str(mph), (0, 0, 0), 75, 260, 55)
    message_display(str(gear), (0, 0, 0), 233, 185, 105)
